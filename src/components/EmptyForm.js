...
class EmptyForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      cityValid: false,
      formErrors: {
        title: 'Обязательное полe. Не более 140 символов',
  ...
  validateField(fieldName, value) {
    ...
    switch (fieldName) {
      ...
      case 'city':
        ...
        fieldValidationErrors.phone = cityValid
          ? 'Заполнено'
          : 'Заполните поле';
        break;
      default:
  ...
  handleSubmit(e) {
    ...
    if (this.state.formValid) {
      ...
      if (e.target.title.value === '')
        fieldValidationErrors.title = 'Заполните поле';
      if (e.target.text.value === '')
        fieldValidationErrors.text = 'Заполните поле';
      if (e.target.phone.value === '')
        fieldValidationErrors.phone = 'Заполните поле';
      if (e.target.city.value === '')
        fieldValidationErrors.city = 'Заполните поле';
      ...
      >
        <div className="form__field">
          <div>
            ...
            <input
              className="input oneline__field"
              type="text"
              name="title"
        ...
        <div className="form__field">
          <div className="form__field">
            <div>
              ...
              <select
                className="oneline__field"
                name="city"
                size="1"
                value={this.state.city}
                onChange={(event) => this.handleChange(event)}
              >
                <option className="defOption" value=""/>
